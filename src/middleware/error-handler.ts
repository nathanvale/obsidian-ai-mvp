  ...
  fastify.setErrorHandler(async (error: FastifyError, request: FastifyRequest, reply: FastifyReply) => {
    ...
    const errorResponse: ErrorResponse = {
      ...
      error: {
        ...
        statusCode,
        code: error.code,
        ...(config.includeStackTrace && error.stack && { details: { stack: error.stack } })
      },
      correlationId,
      timestamp
    };
...
function getErrorMessage(statusCode: number): string {
  switch (statusCode) {
    ...
    case 405: return ErrorMessages.METHOD_NOT_ALLOWED;
    ...
    case 502: return ErrorMessages.BAD_GATEWAY;
    case 503: return ErrorMessages.SERVICE_UNAVAILABLE;
    case 504: return ErrorMessages.GATEWAY_TIMEOUT;
